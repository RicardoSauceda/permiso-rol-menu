<li class="tree-level-{{$level}} mb-2 menu-item">
    <div class="d-flex justify-content-between align-items-center menu-item-content">
        <div class="d-flex align-items-center">
            @if(isset($menu['submenu']) && count($menu['submenu']) > 0)
            <button type="button" class="btn btn-sm btn-link p-0 mr-2 collapse-btn" data-toggle="collapse"
